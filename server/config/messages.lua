...
local defaultLang = Config.Locale or "en"
...
We're excited to see you dive in and start exploring. Welcome to the Loopsverse!
    ...
    Services = {
      MessageSent = msg('services', 'message_sent', 'Message sended!'),
      MessageSolved = msg('services', 'message_solved', 'Message service solved!'),
    },
  }
end

return messagesForLang(defaultLang)
