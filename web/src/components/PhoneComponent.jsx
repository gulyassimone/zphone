        ...
        <div className="flex flex-col justify-center rounded-xl h-full w-full px-3">
          <div className="bg-slate-700 rounded-lg py-2 flex flex-col w-full p-3">
            <div className="flex justify-between items-center pb-2">
              <span className="truncate font-semibold">{t("phone_new_contact_title")}</span>
              <div>
                <MdClose
            ...
            <form onSubmit={handlePhoneFormSubmit} className="w-full">
              <div className="flex flex-col gap-1 py-2 text-xs">
                <span className="flex justify-between items-center">
                  <span>{t("phone_new_contact_name_label")}:</span>
                  <span>
                    <input
                      name="name"
                      className="border-b w-36 text-base font-medium focus:outline-none bg-slate-700"
                      placeholder={t("phone_new_contact_name_placeholder")}
                ...
                <span className="flex justify-between items-center">
                  <span>{t("phone_new_contact_number_label")}:</span>
                  <span>
                    <input
                      name="phone"
                      className="border-b w-36 text-base font-medium focus:outline-none bg-slate-700"
                      placeholder={t("phone_new_contact_number_placeholder")}
                      readOnly={true}
                      value={newPhone}
                      autoComplete="off"
                      required
                      ...
                      <div className="flex flex-col">
                        <span className="text-sm font-medium line-clamp-1">
                          {!v.is_anonim
                            ? v.to_person
                            : v.flag == "OUT"
                            ? t("call_as_anonymous", [v.to_person])
                            : t("call_anonymous")}
                        </span>
      ...
      <div className="absolute bottom-0 w-full pb-2 pt-2.5 bg-black">
        <div className="grid h-full w-full grid-cols-3 mx-auto font-medium">
          ...
          >
            ...
            <span className="text-xs">{t("phone_tab_calls")}</span>
          </button>
          <button
            type="button"
            className={`inline-flex flex-col items-center justify-center px-5 group ${
          ...
          >
            ...
            <span className="text-xs">{t("phone_tab_requests")}</span>
          </button>
          <button
            type="button"
            className={`inline-flex flex-col items-center justify-center px-5 group ${
          ...
          >
            ...
            <span className="text-xs">{t("phone_tab_keypad")}</span>
          </button>
        </div>
      </div>
    </div>
