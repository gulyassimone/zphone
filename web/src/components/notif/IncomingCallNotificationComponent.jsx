...
import { MdCall, MdCallEnd, MdOutlinePhone } from "react-icons/md";
import useSound from "use-sound";
import { MENU_INCOMING_CALL_NOTIFICATION } from "../../constant/menu";
...
const IncomingCallNotificationComponent = ({ isShow }) => {
  ...
  const [play, { stop }] = useSound("/sounds/ringtone.ogg");
