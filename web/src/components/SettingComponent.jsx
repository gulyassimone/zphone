...
import { FaMask, FaMoon, FaRegImage, FaUser } from "react-icons/fa6";
        ...
        <div className="flex flex-col py-2 bg-gray-900 rounded-lg">
          ...
          <div className="flex space-x-3 px-2">
            ...
            <div className="flex w-full justify-between items-center space-x-2 border-b border-gray-800 pb-1.5 mb-1.5">
              <input
                type="text"
                placeholder={t("setting_avatar_placeholder")}
          ...
          <div className="flex space-x-3 px-2">
            ...
            <div className="flex w-full justify-between items-center space-x-2 border-b border-gray-800 pb-1.5 mb-1.5">
              <input
                type="text"
                placeholder={t("setting_wallpaper_placeholder")}
                className="w-full text-xs text-white flex-1 border border-gray-700 focus:outline-none rounded-md px-2 py-1 bg-[#3B3B3B]"
                autoComplete="off"
                value={wallpaper}
                onChange={(e) => {
          ...
          <div className="flex space-x-3 px-2">
            ...
            <div className="flex w-full justify-between items-center space-x-2 border-b border-gray-800 pb-1.5 mb-1.5">
              <select
                title={t("setting_choose_frame")}
                aria-label={t("setting_choose_frame")}
                className="w-full text-xs text-white flex-1 border border-gray-700 focus:outline-none rounded-md px-2 py-1 bg-[#3B3B3B]"
                onChange={(e) => {
                  const { value } = e.target;
                  setFrame(value);
