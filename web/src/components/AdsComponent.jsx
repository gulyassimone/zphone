...
import { MdArrowBackIosNew, MdOutlinePhone, MdWhatsapp } from "react-icons/md";
...
const AdsComponent = ({ isShow }) => {
  ...
  const [playCamera] = useSound("/sounds/camera.ogg");
                      ...
                      <div className="leading-none col-span-4 space-y-1">
                        <div className="flex justify-between w-full">
                          <div className="ml-1.5 leading-tight">
                            ...
                            <div className="line-clamp-1 text-xs text-gray-500 font-normal">
                              {v.phone_number}
                            </div>
                          </div>
                        </div>
